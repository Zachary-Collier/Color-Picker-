...
const App = () => {
  const [selectedColor, setSelectedColor] = useState(
    "Click on a colored circle"
  ); // Step 2 On the first line of your Picker component, invoke the useState hook, and deconstruct the selectedColor and setSelectedColor from the returned array.
  return (
    <div id="container">
      <div id="navbar">
...
// Step 4 is for lines 27 thru 29: Pass the setSelectedColor function down to each of the Color components.

// Step 5 is for line 11: In the Color component, add an onClick property with an anonymous function passed in.
